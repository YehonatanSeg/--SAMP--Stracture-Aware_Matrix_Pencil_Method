function [Poles, Left_modes,  MP_Amplitudes, NEW_Amplitudes,...
    SDD, GAP, EFF, KMEANS, MDL, AIC, CRB, params] = gen_data_N(noise_dist, Nreps, damps)
%% Settings
...
MP_Amplitudes   = cell(length(params.INTERVAL_LENGTH_RANGE), params.Nrep);
NEW_Amplitudes   = cell(length(params.INTERVAL_LENGTH_RANGE), params.Nrep);
